...
scene.add( light );
				...
				//
				var plane_geometry = new THREE.PlaneGeometry(10000, 10000);

				var plane_material = new THREE.MeshLambertMaterial({

					side: THREE.DoubleSide,
					map: THREE.ImageUtils.loadTexture("../new_folder_urist/floor_wood.jpg")
				});
				...
				plane_mesh.position.y = -4000;
				plane_mesh.rotation.x +=(90*Math.PI/180);
				plane_mesh.rotation.z +=(90*Math.PI/90);
...
/*	var mtlLoader = new THREE.MTLLoader();
	mtlLoader.load("js_urist/TableOBJ.mtl", function(materials){

		materials.preload();
		var objLoader = new THREE.OBJLoader();
		objLoader.setMaterials(materials);

		objLoader.load("js_urist/TableOBJ.obj", function(mesh){



			scene.add(mesh);
			mesh.position.z = 3400;

		});

	});*/

/*var lod = new THREE.ObjectLoader();

      var gem =  lod.load( 'js_urist/monkey.json' );
			...
			obj.position.z = -100;			
			scene.add(obj);*/
				/*var cubex_geometry = new THREE.BoxGeometry(700, 700, 700);

				var cubex_material = new THREE.MeshStandardMaterial();

				var cubex_mesh = new THREE.Mesh(cubex_geometry, cubex_material);
				cubex_mesh.position.x = 0;
				cubex_mesh.position.y = -3650;
				cubex_mesh.position.z = -3000;

				scene.add(cubex_mesh);
			*/
			...
			//
				...
				scene.background = new THREE.CubeTextureLoader()
					.setPath( 'new_folder_urist/' )
					.load( [ 'nx.jpg', 'px.jpg',  'py.jpg', 'ny.jpg', 'pz.jpg', 'nz.jpg' ] );


				let images = ['new_folder_urist/adw.svg','new_folder_urist/seo.svg','new_folder_urist/smm.svg'];
