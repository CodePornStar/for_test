...
var plane_geometry = new THREE.PlaneGeometry(10000, 10000);
				...
				var plane_material = new THREE.MeshBasicMaterial({
					...
					map: THREE.ImageUtils.loadTexture("../new_folder_marketing/px.jpg")
				});	
			...
			//
				...
				scene.background = new THREE.CubeTextureLoader()
					.setPath( 'new_folder_marketing/' )
					.load( [ 'nx.jpg', 'px.jpg',  'py.jpg', 'ny.jpg', 'pz.jpg', 'nz.jpg' ] );
				
				
				let images = ['new_folder_marketing/adw.svg','new_folder_marketing/seo.svg','new_folder_marketing/smm.svg','new_folder_marketing/phone.svg'];
