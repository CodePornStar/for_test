...
var container;
			...
			//
				...
				scene.background = new THREE.CubeTextureLoader()
					.setPath( 'new_folder_development/' )
					.load( [ 'nxg.jpg', 'pxg.jpg',  'py.jpg', 'ny.jpg', 'pz.jpg', 'nz.jpg' ] );


				let images = ['new_folder_development/adw.svg','new_folder_development/seo.svg','new_folder_development/smm.svg', 'new_folder_development/temark.svg'];
			...
			loadImages(images,function(loadedImages){
				...
				gallery[0].forEach((el,index)=>{
						...
						geometry.colors.push(new THREE.Color(0x3b3b3b));
					});
